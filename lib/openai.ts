...
export async function generateGroundedChatAnswerOpenAI(
  ...
  const system = [
    ...
    "Output markdown with exact sections in order:",
    "## Direct answer",
    "## Key points",
    "## Sources",
  ].join("\n");
  ...
  const userPrompt = [
    ...
    "Direct answer should be 4-7 coherent sentences.",
    "Key points should be 3-5 concise bullets.",
    "Sources section should list each source title once with category in parentheses.",
    "",
    `Question: ${question}`,
    "",
    "Grounded sources:",

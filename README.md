...
- deterministic retrieval with optional Gemini synthesis for richer chat answers
...
`GEMINI_API_KEY` is optional. If set, chat responses are generated by Gemini using only retrieved database sources. If not set, extractive mode is used.
